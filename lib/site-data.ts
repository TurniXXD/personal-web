...
export const getCapabilityCards = (t: Translator): CapabilityCard[] => [
  ...
  {
    title: t("cards.researchExperimentation.title"),
    summary: t("cards.researchExperimentation.summary"),
    level: t("cards.researchExperimentation.level"),
    items: [
      t("cards.researchExperimentation.items.experimentalWork"),
      t("cards.researchExperimentation.items.measurement"),
      t("cards.researchExperimentation.items.dataCollection"),
    ],
    accent: "cyan",
  },
  {
